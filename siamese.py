...
import colorsys
import os
from nets.siamese2 import siamese
...
class Siamese(object):
    _defaults = {
        "model_path": 'logs/ep108-loss0.613-val_loss0.718.h5',
    ...
    def detect_image(self, image_1, image_2):
        ...
        photo1 = np.expand_dims(np.expand_dims(image_1,-1),0)
        photo2 = np.expand_dims(np.expand_dims(image_2,-1),0)
